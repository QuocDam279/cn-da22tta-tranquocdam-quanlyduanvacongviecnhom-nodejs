...
export default function Login() {
  // ✅ Hook đã có navigate logic, không cần useNavigate
      ...
      <div className="w-full max-w-sm">
        <div className="bg-white/85 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/50 animate-fadeIn text-center">
          ...
          <div className="flex items-center justify-center gap-3 mb-8">
            <div className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent tracking-wide">
              Quản lý công việc
            </div>
          </div>
          ...
          <p className="mt-8 text-xs text-slate-400">
            Hệ thống quản lý dự án và công việc nhóm © 2025
          </p>
