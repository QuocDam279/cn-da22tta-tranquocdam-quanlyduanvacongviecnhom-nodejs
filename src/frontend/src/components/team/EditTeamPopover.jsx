...
export default function EditTeamPopover({ team, onSaved, onClose, isLoading }) {
  ...
  const handleSave = () => {
    ...
    setError("");
    // Gọi callback onSaved từ parent (TeamActions)
    // Parent sẽ handle mutation bằng useUpdateTeam hook
    onSaved({
      team_name: name,
      description,
    });
